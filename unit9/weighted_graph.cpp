...
Bag<Edge>* EdgeWeightedGraph::copy_adj_lists(const EdgeWeightedGraph& g) const {
...
EdgeWeightedGraph::EdgeWeightedGraph(ifstream& ifs) : no_edges(0) {
...
ostream& operator<<(ostream& out, const EdgeWeightedGraph& g) {
    out << g.V() << " " << g.E() << endl;
